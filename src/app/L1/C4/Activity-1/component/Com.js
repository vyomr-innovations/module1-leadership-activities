...
const quizSounds = [
  {
    audio: "https://res.cloudinary.com/dey9w5okl/video/upload/v1732604365/rooster_tw38jb.mp3",
    question: "What sound is this?",
    options: ["Rooster", "Pigeon"],
    correct: "Rooster",
  },
  {
    audio: "https://res.cloudinary.com/dey9w5okl/video/upload/v1732604396/Sheep_oqlior.mp3",
    question: "What sound is this?",
    options: ["Sheep", "Horse"],
    correct: "Sheep",
  },
  {
    audio: "https://res.cloudinary.com/dey9w5okl/video/upload/v1732604914/Ambulance_krgf0n.mp3",
    question: "Guess the sound",
    options: ["Icecream Truck", "Ambulance"],
    correct: "Ambulance",
  },
  {
    audio: "https://res.cloudinary.com/dey9w5okl/video/upload/v1732604986/Lion_Roaring01_szsxgb.mp3",
    question: "Guess the sound",
    options: ["Zebra", "Lion"],
    correct: "Lion",
  },
  {
    audio: "https://res.cloudinary.com/dey9w5okl/video/upload/v1732605018/Dogs_Bark_1_gepyvu.mp3",
    question: "Guess the sound",
    options: ["Cat", "Dog"],
    correct: "Dog",
  },
  {
    audio: "https://res.cloudinary.com/dey9w5okl/video/upload/v1732605103/14784_fire_engines_arrival_gze7w9.wav",
    question: "Guess the sound",
    options: ["Fire Engine", "Ambulance"],
    correct: "Fire Engine",
  },
  {
    audio: "https://res.cloudinary.com/dey9w5okl/video/upload/v1732605145/Jingle_Bells_Jingling_wa5qsq.mp3",
    question: "Guess the sound",
    options: ["Cow bell", "Jingle bells"],
